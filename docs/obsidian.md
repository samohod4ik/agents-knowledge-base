...
- Автоматическую память между агентами без записи на диск.
- Локальный RAG / Telegram-бот — это **не** часть этого репозитория. Здесь только операционный vault + Cursor rules/skills.
